...
const checkUserAgreement = async (email, datePicker) => {
  ...
  var newValues = {
    $set: { "doc.isSigned": true, "doc.signedDate": currentDate },
  };
...
const addSalesInquiryIdToCustomer = async (customerId, inquiryId) => {
  ...
  const customerInquiry = await userCollection.updateOne(
